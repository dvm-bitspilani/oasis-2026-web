    ...
    >
      ...
      >
        <form
          ...
          autoComplete="off"
        >
          {/* HEADING — lives outside the scroll container, exactly
              like .chooseEventsHeading in Events.tsx. It can never
              be scrolled over because it's never inside the
              scrolling element. */}
          <h2 className={styles.regTitle}>Registration</h2>

          {/* SCROLLABLE BODY — the only element that scrolls,
              same role as .eventsList: fixed height, overflow-y
